...
const views = [document.getElementById("error-view"),
               document.getElementById("request-view"),
               document.getElementById("compass-view")];
var currentIndex = -1;

const bottomBackgroundBuffer = document.getElementById("bottom-background-buffer");
...
const locations = [
    ["Marlatt Hall", [[39.1924041500292, -96.58810618021606], "https://th.bing.com/th/id/R.489964d50d1c1af501d354100ec286fa?rik=Qxew17DYRUwvjg&riu=http%3a%2f%2fhousing.k-state.edu%2fimages%2fliving-options%2fmarlatt%2fmarlatt-1.jpg&ehk=s7md3Tpm%2fMaaTVipVnEFke9WzmmGTm5Re%2bg8Z3fRsSw%3d&risl=&pid=ImgRaw&r=0"]],
    ["Goodnow Hall", [[39.19245128961732, -96.58635751670676], "https://housing.k-state.edu/images/about_us/GoodnowSm.png"]],
    ["Wefald Hall", [[39.191826687508595, -96.58583291765396], "https://www.bartlettwest.com/sites/default/files/2017-06/IMG_4285_0.JPG"]],
    ["Kramer Dining Center", [[39.19191507493669, -96.58708739364977], "https://www.broaddusconstruction.com/wp-content/uploads/2020/05/T16_3409.jpg"]],
    ["Engineering Hall", [[39.1909371314614, -96.58416849424121], "https://th.bing.com/th/id/R.3d86475ebe5a6be4d7e453c22f222010?rik=VmsVffOWrV0eWw&riu=http%3a%2f%2fwww.randybraley.com%2fwp-content%2fuploads%2f2016%2f10%2fksu2.jpg&ehk=5Pf1QMzWSYFaam0iq5shhTD0WlP7iD%2bcmluhPc04WEw%3d&risl=1&pid=ImgRaw&r=0"]],
    ["Durland Hall", [[39.190157044564394, -96.58444253759109], "https://stonedetails.com/wp-content/uploads/2019/03/contact-stone-details-bg-2.jpg"]],
    ["Calvin Hall", [[39.18711877291759, -96.58163397144932], "https://fastly.4sqi.net/img/general/600x600/12699647_r55tReIx2D_4IrY0Xkq7P-U5DgxhPW8GiG86ZQJClhI.jpg"]],
    ["Holton Hall", [[39.18993218836137, -96.5800629374026], "https://www.k-state.edu/maps/buildings/S/s.jpg"]],
    ["Ahearn Gymnasium", [[39.189080269048546, -96.58483911969557], "https://www.k-state.edu/maps/buildings/AFH/afh.jpg"]],
    ["Seaton Hall", [[39.1891366958488, -96.58262773759176], "https://www.k-state.edu/maps/buildings/S/s.jpg"]],
    ["Ward Hall", [[39.191619430207446, -96.58303725278611], "https://www.k-state.edu/maps/buildings/WD/wd-s.jpg"]],
    ["Derby Dining Center", [[39.194176115062575, -96.5776082249935], "https://servco-stl.com/wp-content/uploads/2022/11/IMG_9945E-scaled.jpg"]],
    ["Eisenhower Hall", [[39.18950046950845, -96.58056088700222], "https://th.bing.com/th/id/OIP.FEZQyXob1jXQaKsyDDG1KwHaE6?rs=1&pid=ImgDetMain"]],
    ["College of Business", [[39.189451025268184, -96.57742222016529], "https://images.squarespace-cdn.com/content/v1/570815def8baf3b9cbdcc796/1575294844099-R8I9H7KASV84F47Y2E6D/KSU_Business_School-28-edit.jpg?format=1000w"]],
    ["Justin Hall", [[39.19029157270066, -96.57793257259314], "https://images.squarespace-cdn.com/content/v1/570815def8baf3b9cbdcc796/1575665640041-IUZYNKD3992IQPUH1XL8/Justin-Hall-22.jpg"]],
    ["K-State Student Union", [[39.1882445749043, -96.58244919059908], "https://www.bbnarchitects.com/wordpress/wp-content/uploads/2017/08/Thumbnail-Image-2-1024x1024.jpg"]],
    ["Hale Library", [[39.190674534360994, -96.58063136419415], "https://www.k-state.edu/media/images/.private_ldp/a93409/production/master/9c34a7cb-655c-49bb-9631-abbbf66315ed.jpg"]],
    ["Cardwell Hall", [[39.19246930695406, -96.5820348329707], "https://gray-wibw-prod.cdn.arcpublishing.com/resizer/-y177eVevzM1wJ9UjCbIIJpq1HA=/1200x675/smart/cloudfront-us-east-1.images.arcpublishing.com/gray/GMF22M3TIFA73GYT2SSKGPW7SM.jpg"]],
    ["Anderson Hall", [[39.18860418625856, -96.58099055274477], "https://www.bestmastersprograms.org/wp-content/uploads/2015/01/Kansas-State-U-Building.jpg"]],
    ["College of Architecture, Planning & Design", [[39.18997235117392, -96.58177983266198], "https://d3roppooboxrdw.cloudfront.net/work-images/1414_KSU/2017-11-30_Tims-Initial-Images/_xxl/1414_KSU_Round1-2-8.jpg?mtime=20171130101052"]],
    ["Willard Hall", [[39.19144234679258, -96.58018426376265], "https://thumbs.dreamstime.com/b/willard-hall-mark-chapman-gallery-campus-kansas-state-university-manhatten-ks-usa-november-268884825.jpg"]],
];
...
class App {
    ...
    startRoute() {
        ...
        var data = locationDropdown.options[locationDropdown.selectedIndex].dataValue;
    ...
    setBackground(url) {
        ...
        image.onload = () =>
            {
                if (topBackgroundBuffer.style.opacity == "" || topBackgroundBuffer.style.opacity == "0")
                {
    ...
    setViewIndex(index) {
        ...
        currentIndex = index;
        views[currentIndex].style.display = "flex";
    }
    ...
    decimalToStandardLatitude(latitude) {
        ...
        return (
            this.decimalToStandardCoordinate(Math.abs(latitude)) + latitudeDirection
        );
    }
    ...
    decimalToStandardlLongitude(longitude) {
        ...
        return (
            this.decimalToStandardCoordinate(Math.abs(longitude)) + longitudeDirection
        );
    }
